...
public class VisualizarViagens extends javax.swing.JPanel {
    ...
    public synchronized void removeOkVisualizarViagensClicadoListener(OkVisualizarViagensClicadoListener listener) {
        this.okVisualizarViagensClicadoListener.remove(listener);
    }

    protected synchronized void fireOkVisualizarViagensClicadoEvent() {
        for (OkVisualizarViagensClicadoListener listener : this.okVisualizarViagensClicadoListener) {
            OkVisualizarViagensClicadoEvent evento = new OkVisualizarViagensClicadoEvent(this);
            listener.okVisualizarViagensClicado(evento);
        }
    }
